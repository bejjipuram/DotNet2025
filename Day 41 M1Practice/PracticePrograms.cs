...
{
    public class ProgramsFunctions
    {
        public void ToInt()
        {
        ...
        public void ToDouble()
        {
            ...
            Console.WriteLine("Conersion to Double");
        }
    ...
    public class PracticePrograms
    {
        ...
        {
            ProgramsFunctions programobject = new ProgramsFunctions();
            //programobject.ToInt();
            //programobject.SplitToDouble();
            //programobject.ValidateString();
            //programobject.IntOutOfString();
            //programobject.LongConversion();
            //programobject.HexToInt();
            programobject.IntSumFromString();
        }
    }
}

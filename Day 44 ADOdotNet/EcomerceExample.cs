...
namespace CAP2025.Day_44_ADOdotNet
{
    ...
    // =========================
    public class ProductRepository<T> where T : class, IProductInfo
    {
    ...
    // Electronic Product
    // =========================
    public class ElectronicProduct : IProductInfo
    {
        public int Id { get; set; }
        public string? Name { get; set; }
        public decimal Price { get; set; }
        public CategoryInfo Category => CategoryInfo.Electronics;
    ...
    // Discount Wrapper
    // =========================
    public class DiscountedProduct<T> where T : IProductInfo
    {
        private T _product;
    ...
    public class InventoryManager
    {
        ...
        public void ProcessProducts<T>(IEnumerable<T> products) where T : IProductInfo
        {
            Console.WriteLine("\n--- Product List ---");
            ...
            foreach (var p in products
                .Where(p => p.Category == CategoryInfo.Electronics && p.Price > 500))
            {
